...
public class OCRActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyCP9a3D8cXWf73nSUzAvYzHjT4E83xU-nQ";
    ...
    EditText visionAPIData;

    private Feature feature;
    private Bitmap bitmap;
    private String[] visionAPI = new String[]{"TEXT_DETECTION","LANDMARK_DETECTION", "LOGO_DETECTION", "SAFE_SEARCH_DETECTION", "IMAGE_PROPERTIES", "LABEL_DETECTION"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visionAPIData = (EditText) findViewById(R.id.visionAPIData);
    ...
    public String check(){
        Log.d("lang",new CheckLanguage().check(""));
